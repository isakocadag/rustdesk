...
class _DesktopHomePageState extends State<DesktopHomePage>
          ...
          child: SizedBox(
            ...
            child: OutlinedButton.icon(
              style: OutlinedButton.styleFrom(
                foregroundColor: const Color(0xFFFFD7DB),
                backgroundColor: const Color(0xFF5A2028),
                side: const BorderSide(color: Color(0xFFD92D3A), width: 1.4),
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: _buildCustomerConnectionPanel(
                                      connected,
                                    ),
                                  ),
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    _buildCustomerTool(Icons.monitor_rounded,
                                        'Ekran Paylaşımı', connected),
                                    ...
                                    _buildCustomerTool(
                                        ...
                                        connected),
                                    const SizedBox(width: 12),
                                    _buildCustomerTool(Icons.volume_up_outlined,
                                        'Sistem Sesi', connected),
                                    const SizedBox(width: 12),
                                    _buildCustomerTool(
                                        ...
                                        connected),
                                    const SizedBox(width: 12),
                                    _buildCustomerTool(Icons.shield_outlined,
                                        'Güvenli Bağlantı', connected),
                                  ],
                                ),
                              ),
                            ),
  ...
  Widget _buildCustomerConnectionPanel(bool connected) {
    return Container(
      padding: const EdgeInsets.all(22),
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(17),
        border: Border.all(
          color: connected ? const Color(0xFF34765A) : const Color(0xFF553039),
        ),
      ),
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color:
                  connected ? const Color(0xFF214D3B) : const Color(0xFF3A2027),
            ...
            child: Icon(
              ...
              color:
                  connected ? const Color(0xFF65D5A0) : const Color(0xFFF17A84),
              size: 29,
            ),
          ),
          const SizedBox(width: 16),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color:
                  connected ? const Color(0xFF214D3B) : const Color(0xFF242B34),
              borderRadius: BorderRadius.circular(18),
            ),
            child: Text(
        ...
        child: Column(
          ...
          children: [
            Icon(
              icon,
              color:
                  connected ? const Color(0xFFF06470) : const Color(0xFF596674),
              size: 25,
            ),
            Text(
              label,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (kOssisPersonnelHomeBuild) buildPopupMenu(context)
                      ],
                    ),
                  ),
                  Flexible(
  ...
  void dispose() {
    if (!kOssisPersonnelHomeBuild) {
      OssisCustomerSession.instance.removeListener(_enforceCustomerEntitlement);
    }
