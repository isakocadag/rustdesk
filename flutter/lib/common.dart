...
class MyTheme {
  ...
  static const Color accent = Color(0xFFD92D3A);
  static const Color accent50 = Color(0x77D92D3A);
  static const Color accent80 = Color(0xAAD92D3A);
  ...
  static const Color button = Color(0xFFD92D3A);
...
Widget loadPowered(BuildContext context) {
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://ossisbilisim.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
