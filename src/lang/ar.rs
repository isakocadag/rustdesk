...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة Ossis Remote Control..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. Ossis Remote Control قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت Ossis Remote Control في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح Ossis Remote Control اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح Ossis Remote Control اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ Ossis Remote Control باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [Ossis Remote Control Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep Ossis Remote Control background service", "ابق خدمة Ossis Remote Control تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق Ossis Remote Control, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show Ossis Remote Control", "عرض Ossis Remote Control"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من Ossis Remote Control اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح Ossis Remote Control اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في Ossis Remote Control الذي يعمل."),
        ...
        ("verify_rustdesk_password_tip", "تحقق من كلمة مرور Ossis Remote Control"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "ترقية خادم Ossis Remote Control Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع Ossis Remote Control"),
        ...
        ("About Ossis Remote Control", "حول Ossis Remote Control"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "ترقية عميل Ossis Remote Control البعيد إلى {}"),
