...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới Ossis Remote Control..."),
        ...
        ("install_tip", "Do cơ chế UAC, Ossis Remote Control có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt Ossis Remote Control vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho Ossis Remote Control."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho Ossis Remote Control."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [Ossis Remote Control Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep Ossis Remote Control background service", "Giữ dịch vụ Ossis Remote Control chạy nền"),
        ...
        ("Show Ossis Remote Control", "Hiện Ossis Remote Control"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu Ossis Remote Control"),
        ...
        ("scam_text2", "Chỉ sử dụng Ossis Remote Control với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ Ossis Remote Control mở"),
        ...
        ("floating_window_tip", "Giữ Ossis Remote Control trên cùng"),
        ...
        ("About Ossis Remote Control", "Về Ossis Remote Control"),
