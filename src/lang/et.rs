...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ossis Remote Controli võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa Ossis Remote Control mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et Ossis Remote Control oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb Ossis Remote Controlile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb Ossis Remote Controlile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma Ossis Remote Controlile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [Ossis Remote Control Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep Ossis Remote Control background service", "Säilita Ossis Remote Controli taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele Ossis Remote Controli rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show Ossis Remote Control", "Kuva Ossis Remote Control"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma Ossis Remote Controlile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma Ossis Remote Controlile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud Ossis Remote Controli kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita Ossis Remote Controli parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul Ossis Remote Controli kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda Ossis Remote Control Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib Ossis Remote Controlil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb Ossis Remote Controlil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui Ossis Remote Controli aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada Ossis Remote Controli taustateenust."),
        ...
        ("About Ossis Remote Control", "Ossis Remote Controli teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage Ossis Remote Controli klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib Ossis Remote Control TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab Ossis Remote Control kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta Ossis Remote Control enam UDP 21116, vaid kasutatakse selle asemel TCP 21116."),
        ("server-oss-not-support-tip", "MÄRKUS: Ossis Remote Controli serveri OSS ei sisalda seda funktsiooni."),
