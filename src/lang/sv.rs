...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till Ossis Remote Control..."),
        ...
        ("install_tip", "På grund av UAC, kan inte Ossis Remote Control fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera Ossis Remote Control på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge Ossis Remote Control \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge Ossis Remote Control \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [Ossis Remote Control Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep Ossis Remote Control background service", "Behåll Ossis Remote Control i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa Ossis Remote Control programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show Ossis Remote Control", "Visa Ossis Remote Control"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge Ossis Remote Control behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge Ossis Remote Control behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för Ossis Remote Control."),
        ...
        ("verify_rustdesk_password_tip", "Verifiera Ossis Remote Control-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda Ossis Remote Control och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Uppgradera Ossis Remote Control Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra Ossis Remote Control från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("powered_by_me", "Drivs av Ossis Remote Control"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om Ossis Remote Control-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla Ossis Remote Control-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Uppgradera Ossis Remote Control-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar Ossis Remote Control serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar Ossis Remote Control över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder Ossis Remote Control inte längre UDP 21116, utan TCP 21116 används i stället."),
        ("server-oss-not-support-tip", "OBS: Ossis Remote Control server OSS inkluderar inte denna funktion."),
