...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Ossis Remote Control network..."),
        ...
        ("install_tip", "Due to UAC, Ossis Remote Control can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Ossis Remote Control to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Ossis Remote Control \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Ossis Remote Control \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Ossis Remote Control to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Ossis Remote Control Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Ossis Remote Control application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Ossis Remote Control \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Ossis Remote Control \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Ossis Remote Control."),
        ...
        ("verify_rustdesk_password_tip", "Verify Ossis Remote Control password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Ossis Remote Control and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade Ossis Remote Control Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Ossis Remote Control from running properly as controlled side."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Ossis Remote Control window is open"),
        ...
        ("floating_window_tip", "It helps to keep Ossis Remote Control background service"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Ossis Remote Control client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Ossis Remote Control verifies the server certificate for protocols using TLS.\nWith this option enabled, Ossis Remote Control will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option enabled, Ossis Remote Control will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: Ossis Remote Control server OSS doesn't include this feature."),
