...
pub(super) const PRIVACY_WINDOW_CLASS: &'static str = "Ossis Remote ControlPrivacyWindowClass";
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "Ossis Remote ControlPrivacyWindow";
