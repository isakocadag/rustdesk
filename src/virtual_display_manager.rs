...
//  https://github.com/rustdesk-org/Ossis Remote ControlIddDriver/blob/b370aad3f50028b039aad211df60c8051c4a64d6/Ossis Remote ControlIddDriver/Ossis Remote ControlIddDriver.inf#LL73C1-L73C40
pub const RUSTDESK_IDD_DEVICE_STRING: &'static str = "Ossis Remote ControlIddDriver Device\0";
...
pub mod amyuni_idd {
    ...
    // 2. Ossis Remote Control may crash and restart, but the virtual displays are kept.
    //
    ...
    //             if there're no virtual displays managed by Ossis Remote Control.
    pub fn plug_out_monitor(index: i32, force_all: bool, force_one: bool) -> ResultType<()> {
        ...
        //
        // 1. Ossis Remote Control plug in 2 virtual displays. (Ossis Remote Control)
        // 2. Other process plug out all virtual displays. (User manually)
        // 3. Other process plug in 1 virtual display. (User manually)
        // 4. Ossis Remote Control plug out all virtual displays in this call. (Ossis Remote Control disconnect)
        //
        // This is not a normal scenario, Ossis Remote Control will plug out virtual display unexpectedly.
