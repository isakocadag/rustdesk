...
#define MyAppExeName "OssisRemoteSRV.exe"
...
[Icons]
Name: "{autodesktop}\Ossis Support Console"; Filename: "{app}\OssisRemoteSRV.exe"
Name: "{group}\Ossis Support Console"; Filename: "{app}\OssisRemoteSRV.exe"

[Run]
Filename: "{cmd}"; Parameters: "/c ""{app}\postinstall-personnel.cmd"" config"; Flags: runasoriginaluser runhidden waituntilterminated
Filename: "{app}\OssisRemoteSRV.exe"; Description: "Ossis Support Console'u çalıştır"; Flags: nowait postinstall skipifsilent
