...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\Ossis Remote ControlPrinterDriver\\Ossis Remote ControlPrinterDriver.inf";
    LPCWCH RD_PRINTER_PORT = L"Ossis Remote Control Printer";
    LPCWCH RD_PRINTER_NAME = L"Ossis Remote Control Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"Ossis Remote Control v4 Printer Driver";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through Ossis Remote Control Printer.
